        ...
        <div className="container-fluid py-3">
          <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap">
            ...
            <div className="d-flex align-items-center gap-3">
              <a href="/cart" className="btn btn-link text-secondary position-relative p-0"><i className="bi bi-cart4 fs-5"></i><span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">2</span></a>
