        ...
        <>
            <nav className="mobile-bottom-nav d-md-none">
                ...
                <NavLink to="/cart" className={({ isActive }) =>
                    ...
                    <i className="bi bi-cart4 fs-5 position-relative"></i><span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{cartCount}</span>
                    <small>Cart</small>
                </NavLink>
